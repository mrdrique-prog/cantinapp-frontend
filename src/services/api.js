...
export default function App() {
  ...
  useEffect(() => {
    // Inicia contador visual enquanto aguarda o backend
  ...
  if (verificando) {
    // Mostra mensagem de "acordando servidor" após 6s
    ...
    return (
      <div style={{
        ...
        {/* Mensagem de espera após 6 segundos */}
        {acordando && (
          <div style={{
            marginTop: '8px',
            ...
            <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.65)', marginTop: '4px' }}>
              Isso pode levar até 1 minuto na primeira vez. Por favor aguarde.
            </div>
